...
### [AIHealthCheck — AI Fleet Monitoring Platform](https://github.com/shaqir/ai-health-check) · React · FastAPI · Python

- Centralized platform to monitor, evaluate, triage, and govern an organization's AI services
- Full-stack with React + Tailwind frontend, FastAPI backend, SQLite, and Claude API integration
- Tech: React, FastAPI, Python, SQLAlchemy, Anthropic Claude API, APScheduler
